...
export default function ContactCVFrame(props: InterfaceFrame) {
    ...
    return (
        <div className="flex flex-row h-screen w-screen bg-[#A6A6A6] max-[1000px]:flex-col ">
            ...
            <div className="flex flex-col w-[50%] h-screen bg-[#8C8C8C] max-[1000px]:w-screen">
                <div className="w-full flex odibee-sans text-primary text-[64px] justify-center max-[1000px]:text-[30px]">Curriculum</div>
            ...
            <div className="flex flex-col w-[50%]  h-screen bg-[#A6A6A6] max-[1000px]:w-screen">
                <div>
                    <div className="w-full flex odibee-sans text-primary text-[64px] justify-center max-[1000px]:text-[30px]">About me</div>
                    <div className='flex justify-center '>
                        <div className='triangle translate-y-[-43px] rotate-[-58deg]'></div>
                        <div className='bg-[#262626] roboto text-[#A6A6A6] rounded-[17px] p-[10px] text-[18px] w-[713px] max-[1000px]:text-[10px]'>
                ...
                <div className='flex flex-col justify-center align-middle'>
                    <div className="w-full flex odibee-sans text-primary text-[64px] justify-center mt-[100px] max-[1000px]:mt-[10px] max-[1000px]:text-[30px]">Contacts</div>
                    <div className='flex flex-col justify-center roboto-condensed-font text-[20px]'>
            
                        <div className='flex flex-row align-middle items-center justify-center max-[1000px]:text-[14px]'>
